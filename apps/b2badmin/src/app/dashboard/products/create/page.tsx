          ...
          <SidebarInset>
            <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
              <div className="flex items-center gap-2 px-4">
                ...
                <nav className="font-medium text-sm">Create Product</nav>
              </div>
            </header>
            <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
              <div className="flex h-96 items-center justify-center">
                <div className="text-center">
                  <X className="mx-auto mb-4 text-slate-400" size={48} />
                  ...
                  <Link
                    className="mt-4 inline-flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2 text-slate-700 hover:bg-slate-50"
                    ...
                    {INITIAL_TEMPLATES.map((t) => (
                      ...
                      >
                        ...
                        <div className="mt-4 flex gap-2 text-slate-400 text-xs">
                          ...
                          <span>•</span>
                          <span>
                            {t.fields.filter((f) => f.isSkuSpec).length} SKU
                            specs
                          </span>
                        </div>
                      </div>
              ...
              {currentStep === 3 && (
                <div className="p-8 text-center">
                  ...
                  <p className="mx-auto mb-8 max-w-md text-slate-500">
                    ...
                    <strong>{generatedSkus.length}</strong> SKUs for the product{" "}
                  ...
                  <div className="mx-auto max-w-lg space-y-3 rounded-lg bg-slate-50 p-6 text-left text-slate-600 text-sm">
                    ...
                    <p className="flex justify-between border-b pb-2">
                      ...
                      <span>
                        {
                          INITIAL_FACTORIES.find((f) => f.id === factoryId)
                            ?.name
                        }
                      </span>
                    </p>
                    ...
                    <p className="flex justify-between pt-2">
                      ...
                      <span>
                        {generatedSkus.reduce((acc, s) => acc + s.stock, 0)}{" "}
                        units
                      </span>
                    </p>
                  </div>
