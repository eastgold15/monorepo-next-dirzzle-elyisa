...
export function usePermissions() {
  ...
  return {
    ...
    canManageProducts:
      can("product:create") || can("product:update") || can("product:delete"),
    canManageOrders:
      can("order:create") || can("order:update") || can("order:delete"),
    ...
    // 获取用户显示名称
    getUserDisplayName: () => user?.name || user?.email || "未知用户",
