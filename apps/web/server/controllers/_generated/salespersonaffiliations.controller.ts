...
export const salespersonaffiliationsController = new Elysia({ prefix: "/salespersonaffiliations" })
  ...
  .patch("/:id", ({ params, body, db, siteId }) => salespersonAffiliationsService.update(params.id, body, { db, siteId }), { params: t.Object({ id: t.String() }), body: SalespersonAffiliationsContract.Patch })
