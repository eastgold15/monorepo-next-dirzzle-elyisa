...
// 导出扩展类型
export type CreateFactoryWithAdminRequest = typeof CreateFactoryWithAdminRequest.static;
export type CreateFactoryWithAdminResponse = typeof CreateFactoryWithAdminResponse.static;