...
const _Select = createSelectSchema(productSiteCategoriesTable);
const _Insert = createInsertSchema(productSiteCategoriesTable);

export const ProductSiteCategoriesContract = {
  Response: _Select,
  Create: t.Omit(_Insert, ["id", "createdAt", "updatedAt"]),
  Update: createUpdateSchema(productSiteCategoriesTable),
