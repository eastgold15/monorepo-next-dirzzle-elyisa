...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  exporter_admin: [
    ...
    "create_users",
    "edit_users",
    "delete_users", // 只能管理自己出口商下的用户
    "view_factories",
    "create_factories",
    "edit_factories",
    "delete_factories", // 只能管理自己出口商下的工厂
    "view_products",
    "create_products",
    "edit_products",
    "delete_products",
    "publish_products", // 只能管理自己出口商下的商品
    "view_media",
    "upload_media",
    "delete_media",
    "view_orders",
    "process_orders", // 只能处理自己出口商的订单
    "view_analytics",
    "export_reports", // 只能查看自己出口商的数据
    "view_site_config",
    "edit_site_config", // 只能编辑自己出口商的配置
    "view_categories",
    "edit_categories",
    "assign_categories",
  ],
  factory_admin: [
    "view_users",
    "create_users",
    "edit_users", // 只能管理本工厂业务员
    "view_factories",
    "edit_factories", // 只能编辑自己的工厂信息
    "view_products",
    "create_products",
    "edit_products",
    "delete_products",
    "publish_products", // 只能管理本工厂商品
    "view_media",
    "upload_media",
    "delete_media",
    "view_orders",
    "process_orders", // 只能处理本工厂的订单
    "view_analytics", // 只能查看本工厂的分析数据
    "view_categories",
    "assign_categories", // 可以分配类别给业务员
  ],
  salesperson: [
    "view_products",
    "create_products",
    "edit_products", // 只能编辑自己的商品
    "view_media",
    "upload_media",
    "delete_media",
