...
const _Select = createSelectSchema(adsTable);
const _Insert = createInsertSchema(adsTable);

export const AdsContract = {
  Response: _Select,
  Create: t.Omit(_Insert, ["id", "createdAt", "updatedAt"]),
  Update: createUpdateSchema(adsTable),
...
export type AdsDTO = {
  ...
  Update: typeof AdsContract.Update.static;
  Patch: typeof AdsContract.Patch.static;
  ListQuery: typeof AdsContract.ListQuery.static;
};
