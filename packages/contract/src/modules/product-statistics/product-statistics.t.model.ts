...
const PopularProductsQuery = t.Object({
  limit: t.Optional(t.Number({ minimum: 1, maximum: 100, default: 10 })),
  period: t.Optional(Period, { default: "week" }),
  statisticsType: t.Optional(StatisticsType, { default: "view" }),
});
...
export type ProductStatisticsTModel = {
  ...
  PopularProductsQuery: typeof PopularProductsQuery.static;
